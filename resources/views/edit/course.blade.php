        ...
        <div class="text-dark-emphasis bg-dark border border-dark rounded-3 m-4 p-4">
            ...
            <form action="{{ route('courses.update', $course) }}" method="POST">
                ...
                @method('PUT')
                    ...
                    <input name="contact_name" id="contact_name" class="form-control mb-3" value="{{ $course->level }}">   
                        <hr class="text-white">
                        <label for="contact_name" class="form-label text-white">Type:</label>
        ...
        <div class="text-dark-emphasis bg-dark border border-dark rounded-3 m-4 p-4">
            <div class="row">
                <div class="row">
                    ...
                    <hr class="text-white m-2">
                    <label for="contact_name" class="form-label text-white">Choose a chapter to modify:</label>
                    <div class="form-group">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <form id="deleteChapterForm" action="" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <!-- TODO: smth not fine with delete, you can delete everything but not the first chapter in the list -->
